...
if __name__ == '__main__':
    ...
    parser.add_argument("--m", default='', choices=['', 'ilac-0-1', 'ahtapot-5-1', 'biyofiz-4-0','biyofiz-4-1','biyofiz-4-2','biyofiz-4-3','parcore-6-0','iui-5-0'], help='machine name')
    ...
    if len(args.m):
        ...
        if queue == 'ahtapot':
            queue = 'ai'
        elif queue == 'ilac' or queue == 'parcore' or queue == 'iui':
            queue = 'all'
        else:
            queue = 'biyofiz'
        machine = '@%s'%args.m
    ...
    print (args.script, args.d, queue, machine, is_gpu, args.smp, username, username, username, args.smp, args.d, args.script, args.script_args)
